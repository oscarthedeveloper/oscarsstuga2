...
exports.Bildfel = exports.MAX_KALLA_BYTE = exports.MAX_BREDD = void 0;
exports.krympBild = krympBild;
exports.dataUrlByte = dataUrlByte;
/** Största bredd som sparas. Höjden följer proportionerna. */
exports.MAX_BREDD = 300;
/** JPEG-kvalitet. Under 0,6 syns artefakter i text på omslagen. */
const KVALITET = 0.72;
/** Största fil vi ens försöker läsa, innan krympning. */
exports.MAX_KALLA_BYTE = 12 * 1024 * 1024;
class Bildfel extends Error {
}
exports.Bildfel = Bildfel;
/**
...
async function krympBild(fil) {
    ...
    if (fil.size > exports.MAX_KALLA_BYTE) {
        throw new Bildfel("Bilden är för stor. Välj en under 12 MB.");
    }
    const bild = await lasBild(fil);
    const skala = Math.min(1, exports.MAX_BREDD / bild.width);
    ...
    if (!ritare)
        throw new Bildfel("Webbläsaren kunde inte rita om bilden.");
...
async function lasBild(fil) {
    ...
    try {
        return await new Promise((klar, fel) => {
