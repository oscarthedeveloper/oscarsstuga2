...
prov("två som krockar bildar en trappa, den första överst", () => {
    const ut = (0, layout_1.laggUt)([b("a", "09:00", "10:00"), b("b", "09:00", "10:00")]);
    const a = ut.get("a");
    const b2 = ut.get("b");
...
prov("vid samma start ligger det kortaste mötet överst", () => {
    ...
    const ut = (0, layout_1.laggUt)([b("pass", "09:00", "11:00"), b("mote", "09:00", "09:30")]);
...
prov("tre möten i samma pass staplas kortast överst", () => {
    const ut = (0, layout_1.laggUt)([
        b("pass", "09:00", "12:00"),
        b("lang", "09:00", "11:00"),
        b("kort", "09:00", "09:15"),
    ]);
    const z = (n) => ut.get(n).lager;
...
prov("starttiden väger tyngre än längden", () => {
    ...
    const ut = (0, layout_1.laggUt)([b("lang", "09:00", "11:00"), b("kort", "10:00", "10:15")]);
...
prov("många krockar trycker ihop stegen i stället för att svämma över", () => {
    const manga = Array.from({ length: 8 }, (_, i) => b(`x${i}`, "09:00", "10:00"));
    const ut = (0, layout_1.laggUt)(manga);
...
prov("ett femminutersmöte gömmer sig inte helt", () => {
    ...
    const ut = (0, layout_1.laggUt)([b("lang", "09:00", "10:00"), b("kort", "09:02", "09:07")]);
    lika(ut.get("kort").vanster > 0, true, "det korta blocket fick inget eget spår");
});
prov("tom lista ger tom layout", () => {
    lika((0, layout_1.laggUt)([]).size, 0);
});
prov("ordningen på indata spelar ingen roll", () => {
    const ett = (0, layout_1.laggUt)([b("a", "09:00", "10:00"), b("b", "09:30", "10:30")]);
    const tva = (0, layout_1.laggUt)([b("b", "09:30", "10:30"), b("a", "09:00", "10:00")]);
