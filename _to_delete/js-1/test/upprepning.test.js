...
function gor(start, slut, upprepning = null) {
...
const datum = (h, fran, till) => (0, upprepning_1.expandera)(h, (0, tid_1.tolka)(fran), (0, tid_1.tolka)(till)).map((f) => (0, tid_1.nyckel)(f.start));
...
prov("varannan vecka behåller sin fas långt fram", () => {
    ...
    for (const k of d) {
        const v = (0, tid_1.isoVecka)((0, tid_1.tolka)(k));
        lika((v - (0, tid_1.isoVecka)((0, tid_1.tolka)("2026-08-12"))) % 2, 0, `vecka ${v} har fel fas`);
    }
...
prov("avvikelse flyttar en förekomst utan att duplicera den", () => {
    ...
    const f = (0, upprepning_1.expandera)(h, (0, tid_1.tolka)("2026-08-11"), (0, tid_1.tolka)("2026-08-12"));
    lika(f.length, 1, "fel antal förekomster");
    lika((0, tid_1.klocka)(f[0].start), "15:00");
});
...
prov("klockslaget står still över sommartidsomställningen", () => {
    ...
    const f = (0, upprepning_1.expandera)(h, (0, tid_1.tolka)("2026-03-27"), (0, tid_1.tolka)("2026-04-01"));
    for (const x of f) {
        lika((0, tid_1.klocka)(x.start), "09:00", `fel klockslag ${(0, tid_1.nyckel)(x.start)}`);
        lika((0, tid_1.klocka)(x.slut), "10:00", `fel sluttid ${(0, tid_1.nyckel)(x.start)}`);
    }
    lika(f.length, 5);
});
prov("flerdygnshändelse som börjar före fönstret kommer med", () => {
    const h = gor("2026-08-08T00:00", "2026-08-12T00:00");
    const f = (0, upprepning_1.expandera)(h, (0, tid_1.tolka)("2026-08-10"), (0, tid_1.tolka)("2026-08-11"));
    lika(f.length, 1);
});
prov("veckodagIManad hittar sista fredagen", () => {
    const d = (0, upprepning_1.veckodagIManad)(2026, 1, 5, -1); // februari 2026
    lika((0, tid_1.nyckel)(d), "2026-02-27");
});
prov("veckoNummerIManad känner igen den sista", () => {
    lika((0, upprepning_1.veckoNummerIManad)((0, tid_1.tolka)("2026-02-27")), -1);
    lika((0, upprepning_1.veckoNummerIManad)((0, tid_1.tolka)("2026-08-19")), 3);
});
prov("orimlig regel ger ändå ett ändligt svar", () => {
    const h = gor("1990-01-01T09:00", "1990-01-01T10:00", { frekvens: "daglig" });
    const f = (0, upprepning_1.expandera)(h, (0, tid_1.tolka)("2026-08-01"), (0, tid_1.tolka)("2026-08-08"));
    lika(f.length, 7);
});
