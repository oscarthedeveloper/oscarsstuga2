...
const sprak_1 = require("../lib/sidor/sprak");
const markering_1 = require("../lib/sidor/markering");
const bild_1 = require("../lib/bild");
let antal = 0;
let fel = 0;
...
const BIBLIOTEK = (0, sprak_1.tolkaSprakData)({
    hyllor: [
...
prov("skräp in ger ett tomt men användbart bibliotek", () => {
    for (const skrap of [null, undefined, 0, "nej", [], true]) {
        lika((0, sprak_1.tolkaSprakData)(skrap), sprak_1.TOM_SPRAK, `föll på ${JSON.stringify(skrap)}`);
    }
});
prov("poster utan id får ett stabilt sådant", () => {
    const d = (0, sprak_1.tolkaSprakData)({ hyllor: [{ namn: "Italienska" }, {}] });
    lika(d.hyllor.map((h) => h.id), ["h0", "h1"]);
});
prov("tonen kläms till paletten", () => {
    lika((0, sprak_1.klamTon)(0), 0);
    lika((0, sprak_1.klamTon)(5), 5);
    lika((0, sprak_1.klamTon)(6), 0, "sex toner finns, inte sju");
    lika((0, sprak_1.klamTon)(-1), 5);
    lika((0, sprak_1.klamTon)("x"), 0);
});
prov("alla tio blocktyperna tolkas", () => {
    ...
    const block = (0, sprak_1.tolkaBlock)(typer.map((typ, i) => ({ id: `b${i}`, typ })));
    lika(block.map((b) => b.typ), typer);
});
prov("okänd blocktyp faller bort i stället för att krascha", () => {
    const block = (0, sprak_1.tolkaBlock)([
...
prov("halva block fylls i med tomma värden", () => {
    const block = (0, sprak_1.tolkaBlock)([{ typ: "tabell" }, { typ: "ruta" }]);
    lika(block[0], {
        id: "bl0",
        typ: "tabell",
        rubrik: "",
...
prov("okänt rutslag blir info", () => {
    const block = (0, sprak_1.tolkaBlock)([{ typ: "ruta", slag: "katastrof" }]);
...
prov("bladets underrubrik och utkastmärke tolkas", () => {
    const d = (0, sprak_1.tolkaSprakData)({
        blad: [
...
/* --- trädet ------------------------------------------------------- */
prov("trädfrågor", () => {
    lika((0, sprak_1.mapparI)(BIBLIOTEK, "it").map((m) => m.id), ["verb", "idiom"]);
    lika((0, sprak_1.bladI)(BIBLIOTEK, "verb").map((b) => b.id), ["konj", "pres"]);
    lika((0, sprak_1.hyllaMed)(BIBLIOTEK, "de")?.namn, "Tyska");
    lika((0, sprak_1.mappMed)(BIBLIOTEK, "kasus")?.titel, "Kasus");
    lika((0, sprak_1.bladMed)(BIBLIOTEK, "dat")?.titel, "Dativ");
    lika((0, sprak_1.hyllaMed)(BIBLIOTEK, "finns-ej"), null);
});
prov("borttagen hylla tar med sig mappar och blad", () => {
    const kvar = (0, sprak_1.taBortHylla)(BIBLIOTEK, "it");
...
prov("borttagen mapp tar med sig sina blad", () => {
    const kvar = (0, sprak_1.taBortMapp)(BIBLIOTEK, "verb");
...
/* --- ordningen ---------------------------------------------------- */
prov("flytt ett steg", () => {
    lika((0, sprak_1.flytta)(["a", "b", "c"], 0, 1), ["b", "a", "c"]);
    lika((0, sprak_1.flytta)(["a", "b", "c"], 2, -1), ["a", "c", "b"]);
});
prov("flytt utanför kanten gör ingenting", () => {
    const lista = ["a", "b", "c"];
    lika((0, sprak_1.flytta)(lista, 0, -1), lista);
    lika((0, sprak_1.flytta)(lista, 2, 1), lista);
    lika((0, sprak_1.flytta)(lista, -1, 1), lista);
    lika((0, sprak_1.flytta)(lista, 9, -1), lista);
});
prov("nytt böjningsblock kommer med italienska personer ifyllda", () => {
    const b = (0, sprak_1.nyttBlock)("bojning", "x");
    lika(b.typ, "bojning");
    if (b.typ === "bojning") {
...
prov("okänd blocktyp ger ett textblock", () => {
    lika((0, sprak_1.nyttBlock)("hologram", "x").typ, "text");
});
/* --- markeringen -------------------------------------------------- */
prov("fet, kursiv och kod", () => {
    lika((0, markering_1.delaMarkering)("en **fet** och en *kursiv* och `kod`"), [
        { slag: "text", text: "en " },
        { slag: "fet", text: "fet" },
...
prov("tangenterna svarar mot rätt tecken", () => {
    lika((0, markering_1.teckenForTangent)("b"), "**");
    lika((0, markering_1.teckenForTangent)("B"), "**", "skiftläge spelar ingen roll");
    lika((0, markering_1.teckenForTangent)("i"), "*");
    lika((0, markering_1.teckenForTangent)("e"), "`");
    lika((0, markering_1.teckenForTangent)("k"), null, "⌘K är palettens");
    lika((0, markering_1.teckenForTangent)("z"), null);
});
...
prov("data-URL:ens storlek uppskattas", () => {
    ...
    lika((0, bild_1.dataUrlByte)("data:image/jpeg;base64,AAAABBBB"), 6);
    lika((0, bild_1.dataUrlByte)("inte en url"), 0);
});
