...
const Vinuppslag_1 = __importDefault(require("../components/sidor/block/Vinuppslag"));
...
prov("vinuppslaget ritar ett färdigt uppslag utan fält", () => {
     ...
     */
    const vin = (0, viner_1.tolkaVinData)({
        viner: [
            {
                id: "a",
                namn: "Mucho Más Tinto",
    ...
    const html = (0, server_1.renderToStaticMarkup)((0, react_1.createElement)(Vinuppslag_1.default, { vin }));
    ...
    for (const tagg of ["<input", "<textarea", "<select"]) {
        if (html.includes(tagg))
            throw new Error(`läsläget ritade ${tagg}`);
    }
});
prov("ett tomt vin säger att det är tomt", () => {
    ...
    const vin = (0, viner_1.tolkaVinData)({ viner: [{ id: "a" }] }).viner[0];
    const html = (0, server_1.renderToStaticMarkup)((0, react_1.createElement)(Vinuppslag_1.default, { vin }));
...
prov("ett vin utan smakprofil får ingen tom mätare", () => {
     ...
     */
    const saknas = (0, viner_1.tolkaVinData)({
        viner: [{ id: "a", namn: "Okänd flaska", uppgifterSaknas: true }],
    }).viner[0];
    const saknasHtml = (0, server_1.renderToStaticMarkup)((0, react_1.createElement)(Vinuppslag_1.default, { vin: saknas }));
    innehaller(saknasHtml, "går inte att slå upp");
    const ofylld = (0, viner_1.tolkaVinData)({
        viner: [{ id: "a", namn: "Ofylld flaska" }],
    }).viner[0];
    const ofylldHtml = (0, server_1.renderToStaticMarkup)((0, react_1.createElement)(Vinuppslag_1.default, { vin: ofylld }));
...
prov("uppslaget skriver ut åt vilket håll ni är oense", () => {
    ...
    innehaller((0, server_1.renderToStaticMarkup)((0, react_1.createElement)(Vinuppslag_1.default, { vin })), "Du tyckte sämre");
});
